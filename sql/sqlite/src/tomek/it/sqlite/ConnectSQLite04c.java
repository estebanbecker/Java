...
public class ConnectSQLite04c {
	...
	public static void main(String[] args) {
		...
		ResultSet rs = null;
		try {
			rs = stat.executeQuery("select ADDRESS.id address_id, USER.id user_id, name, surname, street, home, room from USER LEFT JOIN ADDRESS on USER.id=ADDRESS.user_id ;");
			while (rs.next()) {
